...
class ReflexCaptureAgent(CaptureAgent):
    ...
    def getBoundaries(self, gameState):  # 算我方的边界和敌方边界，不含城墙
        ...
        rightBorder = width / 2
        leftBorder5Step = leftBorder - 4
        rightBorder5step = rightBorder + 4
        selfBorder = []
        selfBorder5 = []
        enermyBorder = []
        enermyBorder5 = []
        ...
        if not selfState.isPacman:
            ...
            if len(enemiesAtHome) > 0:#有幽灵在家里
                ...
                for ele in enemiesAtHome:
                    ...
                    if distance <= 5 and distanceene2border <= 2 and distanceme2border <= 2:#和对面幽灵距离小于2
